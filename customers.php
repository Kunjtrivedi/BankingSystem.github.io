...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #D8DCD9;">
  ...
  <table class="table table-success table-striped table-hover" style="top: 0;">
  <thead>
    <tr class="td">
  ...
  while ($cust = mysqli_fetch_array($query_run)) {
    ...
    <tr class="td">
      <td><?php echo $cust['CustomerID'] ;?></td>
       ...
       <td><a type="button" class=" btn btn-danger btn-lg" href="transaction.php?cust=<?php echo $cust['CustomerID'] ?>">DETAILS HERE</a></td>
     <!-- <td><a type="button" class="btn btn-success btn-lg"  href="dsdownloads.php?file=<?php  echo $file['ID']?>">Download</a></td>-->
